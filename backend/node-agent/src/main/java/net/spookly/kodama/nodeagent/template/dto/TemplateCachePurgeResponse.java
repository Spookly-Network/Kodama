...
public record TemplateCachePurgeResponse(
  ...
  public static TemplateCachePurgeResponse forTemplate(
      String templateId, TemplateCachePurgeResult result) {
    return fromResult("template", templateId, result);
  }

  private static TemplateCachePurgeResponse fromResult(
      String scope, String templateId, TemplateCachePurgeResult result) {
    TemplateCachePurgeResult safeResult =
        result == null ? new TemplateCachePurgeResult(0, 0, 0) : result;
