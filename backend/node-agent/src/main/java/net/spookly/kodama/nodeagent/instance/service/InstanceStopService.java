...
public class InstanceStopService {
  ...
  @NonNull private final InstanceRegistryService registryService;
  @NonNull private final InstanceWorkspaceLayout workspaceLayout;
  @NonNull private final NodeConfig config;
  @NonNull private final InstanceProperties instanceProperties;
  ...
  public void stopInstance(UUID instanceId) {
    ...
    if (initialStatus == null) {
      ...
      registryService.recordContainerStatus(
          workspace, instanceId, "stopped", exitMetadata.exitCode(), exitMetadata.exitReason());
      return;
    }
  ...
  private void requireWorkspace(InstanceWorkspacePaths workspace) {
    ...
    if (!Files.isDirectory(workspace.instanceRoot())) {
      throw new InstanceStopException(
  ...
  private ExitMetadata resolveExitMetadata(InstanceRegistryEntry registry, String fallbackReason) {
    ...
    String exitReason =
        normalizeExitReason(registry == null ? null : registry.containerExitReason());
