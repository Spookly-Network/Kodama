...
class BlueprintPortDefinitionControllerTest {
    ...
    void listPortDefinitionsReturnsDefinitions() throws Exception {
        ...
        BlueprintPortDefinitionDto definition = new BlueprintPortDefinitionDto(
        ...
        given(blueprintPortDefinitionService.listPortDefinitions(blueprintId)).willReturn(List.of(definition));

        mockMvc.perform(get("/api/blueprints/{id}/ports", blueprintId))
    ...
    void addPortDefinitionReturnsCreatedStatusAndPayload() throws Exception {
        ...
        given(blueprintPortDefinitionService.addPortDefinition(eq(blueprintId), any()))
                .willReturn(new BlueprintPortDefinitionDto(
                        definitionId,
                        "query",
                        "udp",
                        25566,
        ...
        mockMvc.perform(post("/api/blueprints/{id}/ports", blueprintId)
    ...
    void removePortDefinitionReturnsNoContent() throws Exception {
        ...
        mockMvc.perform(delete("/api/blueprints/{id}/ports/{portId}", blueprintId, portId))
    ...
    void addPortDefinitionReturnsBadRequestForInvalidProtocol() throws Exception {
        ...
        given(blueprintPortDefinitionService.addPortDefinition(eq(blueprintId), any()))
                .willThrow(new ResponseStatusException(HttpStatus.BAD_REQUEST, "protocol must be one of: tcp, udp"));
