...
class SchedulingServiceTest {
  ...
  void selectNodeFiltersByStatusAndCapacity() {
    ...
    Node selected =
        schedulingService.selectNodeFromCandidates(
            List.of(offline, full, available), null, null, null, 1);
  ...
  void selectNodeFiltersByRegion() {
    ...
    Node selected =
        schedulingService.selectNodeFromCandidates(
            List.of(euNode, usNode), "us-east-1", null, null, 1);
  ...
  void selectNodeFiltersByTags() {
    Node withTags =
        buildNode("node-tags", "eu-west-1", NodeStatus.ONLINE, false, 3, 1, "primary,ssd");
    Node missingTag =
        buildNode("node-missing", "eu-west-1", NodeStatus.ONLINE, false, 3, 1, "primary");

    Node selected =
        schedulingService.selectNodeFromCandidates(
            List.of(withTags, missingTag), null, "primary, ssd", null, 1);
  ...
  void selectNodeFiltersByDevModeAllowed() {
    ...
    Node devSelected =
        schedulingService.selectNodeFromCandidates(List.of(devNode, prodNode), null, null, true, 1);

    Node prodSelected =
        schedulingService.selectNodeFromCandidates(
            List.of(devNode, prodNode), null, null, false, 1);
  ...
  void selectNodeSortsByUsedSlots() {
    ...
    Node selected =
        schedulingService.selectNodeFromCandidates(List.of(busy, idle), null, null, null, 1);
  ...
  void selectNodeBreaksTiesByName() {
    ...
    Node selected =
        schedulingService.selectNodeFromCandidates(List.of(later, earlier), null, null, null, 1);
  ...
  void selectNodeReturnsNullWhenNoCandidateMatches() {
    ...
    Node selected =
        schedulingService.selectNodeFromCandidates(List.of(offline, full), null, null, null, 1);
  ...
  void selectNodeRequiresAggregateCapacityForRequestedSlots() {
    Node lowerUsedButTooSmall =
        buildNode("node-a", "eu-west-1", NodeStatus.ONLINE, false, 4, 3, null);
    Node eligible = buildNode("node-b", "eu-west-1", NodeStatus.ONLINE, false, 6, 4, null);

    Node selected =
        schedulingService.selectNodeFromCandidates(
            List.of(lowerUsedButTooSmall, eligible), null, null, null, 2);
  ...
  void selectNodeReturnsNullWhenOnlyCapacityIsInsufficient() {
    ...
    Node selected =
        schedulingService.selectNodeFromCandidates(
            List.of(first, second), "eu-west-1", "primary", false, 2);

    boolean hasEligibleByFilters =
        schedulingService.hasEligibleNodesFromCandidates(
            List.of(first, second), "eu-west-1", "primary", false);
