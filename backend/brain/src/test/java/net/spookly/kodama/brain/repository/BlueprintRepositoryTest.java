...
class BlueprintRepositoryTest {
    ...
    void saveAndLoadBlueprintAndAttachmentEntities() {
        ...
        TemplateVersion templateVersion = templateVersionRepository.save(new TemplateVersion(
                template,
                "v1",
                "checksum-1",
        ...
        InstanceGroup group = instanceGroupRepository.save(new InstanceGroup(
                "group-a",
                "primary group",
                now,
                now
        ...
        Blueprint blueprint = blueprintRepository.save(new Blueprint(
                "hytale-default",
                false,
                null,
